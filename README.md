...
2. Type command /newbot, follow instructions to create new bot ![botcreation.gif](doc%2Fgif%2Fbotcreation.gif)
...
5. Input command /addMe for registration ![botconnected.gif](doc%2Fgif%2Fbotconnected.gif)
